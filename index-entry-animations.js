...
const createAnimation = (element, initialKeyframe, endKeyframe = naturalPosition) => {
    const animation = element.animate([initialKeyframe, endKeyframe], entryAnimationTimings);
    animation.pause();
